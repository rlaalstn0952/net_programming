...
REST_API_KEY = '4c1df285325e067dd3af5e4e9ace28a0'
...
class http_handler(BaseHTTPRequestHandler):
    ...
    def process_oauth(self):
        ...
        data = {'grant_type': 'authorization_code',
                ...
                'redirect_uri': 'http://localhost:7777/oauth',
                'code': authorize_code}
...
httpd = HTTPServer(('localhost', 7777), http_handler)
print('Serving HTTP on {}:{}'.format('localhost', 7777))
httpd.serve_forever()
